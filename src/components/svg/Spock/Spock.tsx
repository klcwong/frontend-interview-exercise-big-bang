function Spock() {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 64 64" aria-hidden="true" role="img" className="iconify iconify--emojione" preserveAspectRatio="xMidYMid meet">
            <g fill="#fed0ac">
            ...
            <path d="M59.7 29.2c-1.5-3.1-6.5-2.9-11.6 2.7c-3.5 3.9-5.1 5.3-8.6 5.3l.8-4.5l-30.9 1.2s-1.8 12.8 1.2 19.8c4.5 10.4 27.8 13.2 35.1-4.6c1.5-3.5 4.4-6.1 7.1-9.4c3.1-4 8.6-7.1 6.9-10.5" fill="#fed0ac">
            </path>
            <g fill="#e0a372">
